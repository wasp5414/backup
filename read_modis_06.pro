FUNCTION read_modis_06, file

file='/home/Data2/5_MODIS/MYD06/MYD06_L2.A2007120.1455.006.2014051222714.hdf'
...
FOR ix=0, nx-1 DO BEGIN
  date[ix,iy] = $
  string(year[ix,iy],mon[ix,iy],day[ix,iy],format='(I4 ,I02,I02)')+'T'+ $
  string(hour[ix,iy],min[ix,iy],sec[ix,iy],format='(I02,I02,I02)')+'Z'
ENDFOR & ENDFOR

result = {nxtrack:nx, nline:ny, lon:lon, lat:lat, cot:cot, cf:cf, $
cphase:cphase, ctp:ctp, jtime:time}
