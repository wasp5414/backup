...
myd06={nxtrack:nx, nline:ny, lon:lon, lat:lat, cot:cot, cf:cf, cphase:cphase, ctp:ctp, jtime:time}

save,file=xdrpath+xdrfn,/xdr,myd06

endif else restore,xdrpath+xdrfn
