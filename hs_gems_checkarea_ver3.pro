pro hs_gems_checkarea_ver3,xdrmod=xdrmod,which_avgk=which_avgk,which_plot=which_plot
...
; OUTPUT: 
;
; - tropopause pressure mapplot with omi orbit area
; ****NOT COMPLETED****
;+---------------------------------------------------------------------------+
...
; read fnl file
if (which_plot ge 15 and which_plot le 17) then hs_read_fnl,fnl,ymd=ymd
stop
;+---------------------------------------------------------------------------+
;
; #1.Plot on map 
...
;+---------------------------------------------------------------------------+
  ...
  titles=['Area cloud check '+type,'Area column ozone check '+type ,$ ;0,1
          ...
          'Tropopause pressure'                        ,$ ;15
          'North tropoause pressure'                   ,$ ;16
          'South tropause pressure']                      ;17
  ...
  'ctp'+which_date,'ctp_n'+which_date,'ctp_s'+which_date,$ ;12,13,14
  'fnltp'+which_date,'fnltp'+which_date,'fnltp'+which_date];15,16,17
  ...
  coltables = [49,72,72,49,72,49,72,72,72,72,72,72,49,49,49,49,49,49]
  ...
  levs = ['cfraclev','totallev','totallev2','cfraclev','totallev3', $
          'cfraclev','strlev'  ,'troplev' ,'strlev'   ,'strlev'  ,  $
          'troplev'  ,'troplev','ctplev','ctplev','ctplev','tplev', $
          'tplev','tplev']
  void = execute('lev=' + levs[which_plot])
  
  datalist = ['cfrac','co3[0,*]','co3[0,*]','cfrac','co3[0,*]','cfrac', $
              'co3[1,*]','co3[2,*]','co3[1,*]','co3[1,*]','co3[2,*]',   $
              'co3[2,*]','ctp','ctp','ctp','tp','tp','tp']
