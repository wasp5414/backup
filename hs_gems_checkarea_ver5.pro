...
pro hs_gems_checkarea_ver5,loop=loop,xdrmod=xdrmod,which_plot=which_plot $
...
; "WHICH_PLOT" OPTION
; 
; PLOT ADJUSTED GEMS RESULT ON MAP, FOR EACH COLUMN(TOTAL,STRATOSPEHRE,
; TROPOSPHERE)
;+---------------------------------------------------------------------------+
...
mydoutpath   ='/home/o3p_hs/GEMS/o3p/dat/out/'
...
formats=['(i3)','(i3)','(i3)','(i3)','(i3)','(i3)','(i3)','(i7)']
titles=['Adjusted total column O3','Adjusted statosphere column O3', $
        'Adjusted troposphere column O3']

figtags     = ['to3_wide_adj','sto3_wide_adj','tto3_wide_adj', $
               'to3diff_wide','strdiff_wide','trodiff_wide'  , $
               'ctpdiff_wide']
layertags   = ['tc','stc','ttc','tc','stc','ttc','ctp']

levlist     = ['total3','strat','trop','to3diff','strdiff','trodiff' $
              ,'ctpdiff']
datalist    = ['adj_gems','adj_gems','adj_gems', $
               'diff_gems', 'diff_gems','diff_gems', $
               'diff_ctp']
columns     = [0,1,2,0,1,2,0]

coltables   = [72,72,72,72,72,72,72]
revcol      = [0,0,0,0,0,0,0]
limitlist   = ['wide','wide','wide','wide','wide','wide','wide']
badpixcols  = ['Gray','Gray','Gray','Gray','Gray','Gray','Gray']
