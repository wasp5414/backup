...
PRO hs_gems_wind,day,layer=layer,xdrmod=xdrmod
;+---------------------------------------------------------------------------+
; RUN : hs_wind_over_gems, 200180126, layer=0, xdrmod=1
...
title=strtrim(day)+' '+name1[layer]+' column O3, '+STRING(fpres[selpo],F='(I4)')+'hPa Wind'
