...
pro hs_gems_checkarea_ver7,loop=loop,xdrmod=xdrmod,which_plot=which_plot $
                          ,which_column=which_column

;+---------------------------------------------------------------------------+
; RUN : hs_gems_checkarea_ver7,xdrmod=1
...
; "WHICH_PLOT" OPTION
; PLOT : DIFFERENCE OF DATA, GEMS vs MODIS 
; NOT USE WHICH_COLUMN OPTION. DEPRECATED AND USE "WHICH_PLOT" INSTEAD
; 
;+---------------------------------------------------------------------------+
