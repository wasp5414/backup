...
;
; CALLING SEQUENCE:
;   colorbar_2,levels,colors,/col,/right,/noframe,charsize=charsize,$
...
;   colorbar_2,levels,colors,format='(i4)',/col,/right,$
...
;-
pro colorbar_2,levels,colors,col=col,charsize=charsize,format=format,$
